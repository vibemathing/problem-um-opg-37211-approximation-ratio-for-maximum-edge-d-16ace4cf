...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-37211-approximation-ratio-for-maximum-edge-d-16ace4cf-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-37211"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-37211-approximation-ratio-for-maximum-edge-d-16ace4cf-v1",
      "problem_contract_sha256": "88d113aa8ee9e4e10080f9ad72712fe46e1b8ab538b3e27fde87ba3d6c4f36bd",
      "problem_id": "problem:um-opg-37211-approximation-ratio-for-maximum-edge-d-16ace4cf",
      "route_id": "route:um-opg-37211-approximation-ratio-for-maximum-edge-d-16ace4cf-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-37211-approximation-ratio-for-maximum-edge-d-16ace4cf-source-fidelity-01",
      "graph_id": "graph:um-opg-37211-approximation-ratio-for-maximum-edge-d-16ace4cf-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-37211-approximation-ratio-for-maximum-edge-d-16ace4cf-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-37211-approximation-ratio-for-maximum-edge-d-16ace4cf-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture Can the approximation ratio $O(\\sqrt{n})$ be improved for the Maximum Edge Disjoint Paths problem (MaxEDP) in planar graphs or can an inapproximability result stronger than $\\mathcal{APX}$-hardness?"
          },
          "statement_sha256": "b09f08204a9188d019795b20bdf9ed525bed55c336a47bd8ae92812efd70e320"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-37211-approximation-ratio-for-maximum-edge-d-16ace4cf-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-37211-approximation-ratio-for-maximum-edge-d-16ace4cf-root",
      "route_id": "route:um-opg-37211-approximation-ratio-for-maximum-edge-d-16ace4cf-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-37211-5fc694e8767b",
        "url": "https://www.unsolvedmath.com/problems/OPG-37211"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
